            ...
            <div className="bg-white border border-border rounded-sm">
                <table className="w-full text-sm">
                    ...
                    <tbody data-testid="products-table">
                        {products.map((p) => (
                            <tr key={p.id} className="border-b border-border last:border-0 hover:bg-surface cursor-pointer" onClick={() => nav(`/crm/products/${p.id}`)} data-testid={`product-row-${p.country_code}`}>
